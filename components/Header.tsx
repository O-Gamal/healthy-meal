  ...
  return (
    <header className='py-10 flex w-full justify-between items-center mb-10'>
      ...
      {noSearch ? (
        <button
          onClick={() => router.back()}
          className='border border-red text-red border-z py-2 px-5 transition-colors duration-200 hover:bg-red hover:font-semibold hover:text-dark-primary rounded-md flex items-center gap-3'
        >
          <ArrowLeftIcon className='w-h h-5' />
          Go Back
        </button>
      ) : (
        <SearchBar />
